...
- (IBAction)onDoneButtonTapped:(id)sender {
    ...
    UIImage *smallerImage = [PCPhoto imageWithImage:self.profilePictureImageView.image scaledToSize:CGSizeMake(self.profilePictureImageView.image.size.width/3, self.profilePictureImageView.image.size.height/3)];
